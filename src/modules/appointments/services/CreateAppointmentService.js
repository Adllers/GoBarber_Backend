...
var CreateAppointmentService = /** @class */ (function () {
    function CreateAppointmentService(appointmentsRepository, //from typescript -> using private, i don't need to do -> this.appointmensRepository = appointmentsRepository
    notificationsRepository, cacheProvider) {
    ...
    CreateAppointmentService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var appointmentDate, findAppointmentsInSameDate, appointment, dateFormatted;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (user_id === provider_id) {
                            throw new AppError_1.default('You can not create an appointment with yourself');
                        }
                        if (date_fns_1.getHours(appointmentDate) < 8 || date_fns_1.getHours(appointmentDate) > 17) {
                            throw new AppError_1.default('You can only create appointments between 8an and 5pm');
                        }
                        return [4 /*yield*/, this.appointmentsRepository.findByDate(appointmentDate, provider_id)];
                    case 1:
                        findAppointmentsInSameDate = _b.sent();
                        if (!findAppointmentsInSameDate) return [3 /*break*/, 2];
                        throw new AppError_1.default('This appointment is already booked!');
                    case 2: return [4 /*yield*/, this.appointmentsRepository.create({
