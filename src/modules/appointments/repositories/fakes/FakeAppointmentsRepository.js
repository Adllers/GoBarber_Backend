...
var AppointmentsRepository = /** @class */ (function () {
    ...
    AppointmentsRepository.prototype.findByDate = function (date, provider_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                findAppointment = this.appointments.find(function (appointment) { return date_fns_1.isEqual(appointment.date, date) && appointment.provider_id == provider_id; });
                return [2 /*return*/, findAppointment];
            });
        });
    };
    AppointmentsRepository.prototype.findByMonthAppointmentsFromProvider = function (_a) {
    ...
    AppointmentsRepository.prototype.findByDayAppointmentsFromProvider = function (_a) {
